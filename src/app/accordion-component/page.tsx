...
const page = () => {
  return (
    <div>
      <div>
        <AccordionComponent
          question="What are the Scholarship Programs offered by the School?"
      ...
      <div>
        <AccordionComponent
          question="How much is/are the grants given to students?"
          isAccordionOpen={true}
        >
          <div className=" leading-loose">
      ...
      <div>
        <AccordionComponent
          question="How to apply for the Scholarship Program?"
          isAccordionOpen={true}
        >
          <div>
      ...
      <div>
        <AccordionComponent
          question="I have a Government Grant, is it okay to apply for GIA or JSF Program?"
          isAccordionOpen={true}
        >
          <div>
            Preregistration is the prelisting of students, prior to the
      ...
      <div>
        <AccordionComponent
          question="Does GIA or JSF have allowances?"
          isAccordionOpen={true}
        >
          <div>
            Preregistration is the prelisting of students, prior to the
      ...
      <div>
        <AccordionComponent
          question="How to know the result of the GIA Application?"
          isAccordionOpen={true}
        >
          <div>
            Preregistration is the prelisting of students, prior to the
      ...
      <div>
        <AccordionComponent
          question="I am an ADDU Senior High School and have GIA, will I also apply?"
          isAccordionOpen={true}
        >
          <div>
            Preregistration is the prelisting of students, prior to the
      ...
      <div>
        <AccordionComponent
          question="How is/are grantees chosen?"
          isAccordionOpen={true}
        >
          <div>
            Preregistration is the prelisting of students, prior to the
      ...
      <div>
        <AccordionComponent
          question="Is there a grade that Scholars need to maintain?"
          isAccordionOpen={true}
        >
          <div>
            Preregistration is the prelisting of students, prior to the
