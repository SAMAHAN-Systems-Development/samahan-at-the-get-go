    ...
    <section className="container-xs sm:container-sm md:container-md lg:container-lg my-5 lg:my-10 lg:flex lg:flex-wrap lg:justify-center grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
      <RIAModalUI title="SIS & ADDU Emails">
        ...
        <AccordionComponent question="What is the student’s obligation in the use of the Student Information System?">
          ...
          student’s failure to notice the same in his SIS shall not be corrected
          thereafter.
        </AccordionComponent>
      ...
      <RIAModalUI title="AdDU Online Learning">
        <AccordionComponent question="What applications will professors use?">
          ...
          as the official medium to post their assignments and assessments, and
      ...
      <RIAModalUI title="AdDU GSuite Account">
        ...
        <AccordionComponent question="Why have I not received a response to my emails?">
          There is heavy traffic as there are many concerns that are being sent
          to multitude of students. However, it is assured that assigned
      ...
      <RIAModalUI title="Scholarship">
        ...
        <AccordionComponent question="How to apply for the Scholarship Program?">
          <div className=" leading-loose">
            <ol className="list-decimal px-4 list-inside">
              The application will be through online which will be posted on our
        ...
        <AccordionComponent question="How to know the result of the GIA Application?">
          We will text or email the applicants. Mobile and Email address during
          application must be active.
        </AccordionComponent>

        <AccordionComponent question="I am an ADDU Senior High School and have GIA, will I also apply?">
          Yes, ADDU SHS graduates are required to apply for GIA Grant. There is
          no automatic granting for ADDU SHS graduates.
        </AccordionComponent>

        <AccordionComponent question="How is/are grantees chosen?">
          The committee will deliberate on the information provided, as well as
      ...
      <RIAModalUI title="Enrollment & Registration">
        ...
        <AccordionComponent question="Is enrollment guaranteed with pre-registration?">
          The pre-registered courses shall remain in the student’s SIS account
          until the commencement of the Enrolment Confirmation and Reservation
          Cancellation Procedure.Unpaid registrations shall be thereafter deemed
          expired, and slots reserved shall be vacated. Vacated slots shall be
          made available to other students.Students are encouraged to confirm
          their enrollment via their payment of the fees before the deadline
          set. Otherwise, they may be compelled to find other open slots during
          the enrollment period.
        </AccordionComponent>

        <AccordionComponent question="When and how can pre-registration be done?">
          Given the prevailing health conditions, adding and dropping are done
          until the first week of the semester or the first two days during
          summer, online via sis.addu.edu.ph. No request for adding and dropping
        ...
        <AccordionComponent question="When will a student be tagged as Enrolled after he/she has paid for at least the minimum required tuition fee down payment?">
          It will take one (1) to three (3) banking days for the student’s My
          Registration page on his/her SIS account to have the status of
        ...
        <AccordionComponent question="Why does a student have un-updated registration during enrollment?">
          <div className="leading-loose ">
            ...
            <ol className="list-disc list-inside px-4 ">
              ...
              <li>
                QPI Hold – For not obtaining the required QPI to be retained in
                the University. The student has to contact the concerned
        ...
        <AccordionComponent question="Why can’t a student find the subject even if he searched for the correct subject code or class code?">
          The search function is limited only to the subjects included in the
          student’s curriculum assignment. If the subject is outside of the
          student’s specific curricula, it can’t be searched.
        </AccordionComponent>

        <AccordionComponent question="If class has been filled up, may a student ask for a slot extension?">
          No. Class sizes are fixed for the efficient delivery of instruction
          and in compliance with existing school and CHED regulations.
        </AccordionComponent>
        ...
        <AccordionComponent question="What is the difference between dropping and withdrawal?">
          ...
          student, as opposed to “adding” which is the inclusion of those where
          the latter has not previously been enlisted for. Withdrawal on the
          other hand is the deletion of all the student’s enlistment for the
          semester.
        </AccordionComponent>

        <AccordionComponent question="Can a student enroll after the enrollment period or when classes have already started?">
          Late enrollment may be allowed until the first week of the semester or
          the first two days during summer, subject to the payment of
          surcharges. Students who failed to confirm their enrollment via their
          payment of the fees before the deadline set (or the commencement of
          the Enrolment Confirmation and Reservation Cancellation Procedure)
          shall be treated as late enrollees when no payment has been made prior
        ...
        <AccordionComponent question="If a student overpays for the previous semester, is he automatically enrolled?">
          For the upcoming semesters, if the overpayment is sufficient to cover
          the fees required for enrollment, the student will be tagged as
          enrolled.
        </AccordionComponent>
        ...
        <AccordionComponent question="When and how can withdrawal be made?">
          A student may officially withdraw his enrollment within six weeks from
          the start of the semester or within two weeks from the start of summer
          school. No request for withdrawal will be entertained thereafter. For
          now, this may be done by sending a request to admissions@addu.edu.ph
          (for the first years and, new students) and registrar@addu.edu.ph (for
          old students).
        </AccordionComponent>
        ...
        <AccordionComponent question="Can a transferee’s previously taken subject/s be credited in AdDU?">
          It will depend on the subject and respective policy of the student’s
          desired program department. The student can contact his/her desired
