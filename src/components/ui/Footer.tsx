  ...
  return (
    <footer className="w-full bg-beige text-lightBlue p-10">
      <div className="flex flex-col lg:flex-row">
        <div className="">
          <div className="order-1 lg:flex flex-row">
          ...
          <div className="mb-2 grid md:grid-cols-3 lg:grid-cols-3 order-last md:w-[461px] ">
            <div className="mb-2">
        ...
        <div className="grid mb-10 md:text-sm lg:grid lg:grid-cols-1 lg:justify-items-end order-2 lg:text-right">
