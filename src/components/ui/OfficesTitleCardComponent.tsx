...
const OfficesTitleCardComponent: React.FC<OfficesTitleCardComponentProps> = ({
  ...
  return (
    <div className="grid h-[262px] overflow-auto p-4 w-full content-between text-lightBlue bg-transparent rounded-card border-card border-lightBlue sm:h-[400px] md:h-[622px] md:p-8 lg:h-[681px] lg:p-16">
