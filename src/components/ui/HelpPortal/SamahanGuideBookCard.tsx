...
const SamahanGuideBookCard = () => {
  return (
    <div className="flex flex-col w-full border-solid border-card border-lightBlue rounded-section-card text-lightBlue justify-end text-center items-center h-[30rem] py-[2.44rem] px-7 md:content-start md:text-right md:justify-center md:items-end md:py-[4.12rem] md:px-[2.56rem] md:h-fit lg:px-[5.87rem] lg:pt-[3.88rem]">
