...
const RecWeekModalButton: FC<RecWeekModalButtonProps> = ({
  ...
  return (
    <div className="w-full flex justify-between items-center border-card border-lightBlue rounded-section-card p-5 sm:p-7 md:p-9 lg:p-9 group hover:bg-lightBlue hover:cursor-pointer transition-all ease-in-out duration-300">
      <div className="text-lightBlue group-hover:text-white transition-all ease-in-out duration-300">
        <p className="font-artega text-left uppercase text-[0.8rem] sm:text-[1.3rem] md:text-[1.5rem] lg:text-[1.8rem]">
          {name}
        </p>
