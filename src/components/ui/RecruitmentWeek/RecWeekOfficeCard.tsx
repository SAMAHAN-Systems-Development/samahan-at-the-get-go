...
const RecWeekOfficeCard: React.FC<RecWeekOfficeCardProps> = ({
  ...
  return (
    <div className="grid content-between w-full border-solid border-card border-lightBlue text-white bg-lightBlue h-[17.875rem] md:h-[26.75rem] px-[3rem] py-[3.27rem] md:px-[3.39rem] md:py-[3.63rem] lg:px-[4.68rem] lg:pt-[5rem] lg:pb-[3.25rem]">
