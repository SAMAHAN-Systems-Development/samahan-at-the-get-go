...
const SmallOfficesCard: React.FC<SmallOfficesCard> = ({
  ...
  return (
    <div className="overflow-hidden relative h-80 lg:h-[30rem] w-full grid content-between text-white -z-10 px-[2.53rem] py-[2.31rem] border-solid border-card rounded-section-card">
      <Image
        src={imageUrl}
